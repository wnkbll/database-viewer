...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.ui.newFieldButtonPage1.clicked.connect(
            self.add_column_button_clicked(self.ui.gridLayout1, self.add_page_columns)
        )
        self.ui.newFieldButtonPage2.clicked.connect(
            self.add_column_button_clicked(self.ui.gridLayout2, self.edit_page_columns)
        )
        ...
        self.ui.removeFieldButtonPage1.clicked.connect(
            self.remove_column_button_clicked(self.ui.gridLayout1, self.add_page_columns)
        )
    ...
    def add_button_clicked(self) -> None:
        if self.ui.gridLayout1.itemAt(0) is None:
            ...
            self.place_widget(column_widget, self.ui.gridLayout1, self.add_page_columns)
    ...
    def edit_button_clicked(self) -> None:
        if len(self.ui.tablesList.selectedItems()) != 0:
            ...
            for field in fields:
                ...
                self.place_widget(column_widget, self.ui.gridLayout2, self.edit_page_columns)
